...
const BURGER_PRODUCTS: FoodItem[] = [
  {
    id: 'burg1',
    brand: 'BURGER KING',
    title: 'Monster Smokey Beef Burger',
  ...
  },
  {
    id: 'burg2',
    brand: 'KFC BD',
    title: 'Zinger Burger & Fries Combo',
  ...
  },
  {
    id: 'burg3',
    brand: 'PIZZA HUT',
    title: 'Loaded Chicken Supreme Pizza (8")',
  ...
  },
  {
    id: 'burg4',
    brand: 'TASTEBUD',
    title: 'Loaded Cheese French Fries',
...
interface FoodFastFoodBurgersProps {
  onAddToCart?: (item: FoodItem) => void;
  onViewAllPress?: () => void;
}

export const FoodFastFoodBurgers: React.FC<FoodFastFoodBurgersProps> = ({
  onAddToCart,
  onViewAllPress,
}) => {
