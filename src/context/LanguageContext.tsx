...
const translations: Record<string, { EN: string; BN: string }> = {
  ...
  viewAllCommon: { EN: 'View All', BN: 'সব দেখুন' },
  ...
  securePaymentsSubDesc: { EN: '100% secure checkout', BN: '১০০% নিরাপদ চেকআউট' },
  ...
  shoppingBag: { EN: 'Your Shopping Bag', BN: 'আপনার শপিং ব্যাগ' },
  clearAll: { EN: 'Clear All', BN: 'সব মুছুন' },
  clearCartConfirm: { EN: 'Are you sure you want to remove all items from your bag?', BN: 'আপনি কি ব্যাগ থেকে সব পণ্য মুছে ফেলতে চান?' },
  cancel: { EN: 'Cancel', BN: 'বাতিল' },
  addMoreForFreeDelivery: { EN: 'Add ৳{amount} more for FREE Delivery!', BN: 'ফ্রি ডেলিভারির জন্য আরও ৳{amount} যোগ করুন!' },
  freeDeliveryUnlocked: { EN: 'You unlocked FREE Delivery!', BN: 'আপনি ফ্রি ডেলিভারি পেয়েছেন!' },
  emptyCartTitle: { EN: 'Your Shopping Bag is Empty', BN: 'আপনার শপিং ব্যাগ খালি' },
  emptyCartSub: { EN: 'Browse our categories or search for products to start shopping.', BN: 'পণ্য কিনতে ক্যাটাগরি ব্রাউজ করুন অথবা সার্চ করুন।' },
  selectAllItems: { EN: 'Select All Items', BN: 'সব পণ্য সিলেক্ট করুন' },
  selectedCount: { EN: 'Selected', BN: 'টি সিলেক্টেড' },
  deselectAll: { EN: 'Deselect All', BN: 'সব আনসিলেক্ট করুন' },
  applyPromoCode: { EN: 'APPLY PROMO CODE', BN: 'প্রোমো কোড প্রয়োগ করুন' },
  enterPromoPlaceholder: { EN: 'e.g. JADUFIRST', BN: 'যেমন- JADUFIRST' },
  applyBtn: { EN: 'Apply', BN: 'অ্যাপ্লাই' },
  applied: { EN: 'Applied', BN: 'গৃহীত' },
  firstOrderDiscountHint: { EN: 'First order 20% off:', BN: 'প্রথম অর্ডারে ২০% ছাড়:' },
  orderSummaryTitle: { EN: 'ORDER SUMMARY', BN: 'অর্ডারের সারসংক্ষেপ' },
  itemsSubtotal: { EN: 'Items Subtotal', BN: 'পণ্যসমূহের মূল্য' },
  deliveryCharge: { EN: 'Delivery Charge', BN: 'ডেলিভারি চার্জ' },
  freeText: { EN: 'FREE', BN: 'ফ্রি' },
  promoDiscount: { EN: 'Promo Discount', BN: 'প্রোমো ডিসকাউন্ট' },
  grandTotalTitle: { EN: 'Grand Total', BN: 'সর্বমোট প্রদেয়' },
  checkoutBtn: { EN: 'CHECKOUT', BN: 'চেকআউট' },
  grandTotalHeader: { EN: 'GRAND TOTAL', BN: 'সর্বমোট' },

  // Offers Screen Translations
  exclusiveDealsTitle: { EN: 'EXCLUSIVE DEALS & COUPONS', BN: 'এক্সক্লুসিভ ডিল ও কুপন' },
  exclusiveDealsSub: { EN: 'Save big on your daily shopping with our official discount vouchers.', BN: 'আমাদের অফিশিয়াল ভাউচার কোড ব্যবহার করে পান আকর্ষণীয় ছাড়।' },
  allOffers: { EN: 'All Offers', BN: 'সব অফার' },
  copyCodeBtn: { EN: 'COPY CODE', BN: 'কোড কপি করুন' },
  codeCopied: { EN: 'COPIED!', BN: 'কপি হয়েছে!' },
  minOrderLabel: { EN: 'Min Order:', BN: 'নূন্যতম অর্ডার:' },
  expiresOnLabel: { EN: 'Expires:', BN: 'মেয়াদ:' },
  howToRedeemTitle: { EN: 'HOW TO REDEEM', BN: 'কীভাবে অফার ব্যবহার করবেন' },
  howToRedeemSub: { EN: '3 Simple Steps to Save on Every Order', BN: 'প্রতি অর্ডারে ছাড় পাওয়ার ৩টি সহজ ধাপ' },
  step1Title: { EN: '1. Copy Coupon Code', BN: '১. কুপন কোড কপি করুন' },
  step1Sub: { EN: 'Tap "COPY CODE" on any offer card above to copy the code to your clipboard.', BN: 'যেকোনো অফার কার্ডের "কোড কপি করুন" এ ট্যাপ করুন।' },
  step2Title: { EN: '2. Add Items to Cart', BN: '২. কার্টে পণ্য যোগ করুন' },
  step2Sub: { EN: 'Browse your favorite products, food, or services and add them to your cart.', BN: 'আপনার পছন্দের পণ্য বা সার্ভিস সিলেক্ট করে কার্টে যোগ করুন।' },
  step3Title: { EN: '3. Paste & Enjoy Savings', BN: '৩. পেস্ট করে ছাড় উপভোগ করুন' },
  step3Sub: { EN: 'Go to Cart, paste the code in the promo box and click Apply for instant discount.', BN: 'কার্ট পেজে গিয়ে কোডটি পেস্ট করুন এবং অ্যাপ্লাই এ চাপুন।' },

  // Search Screen Translations
  searchPlaceholder: { EN: 'Search products, groceries & services...', BN: 'পণ্য, মুদি সামগ্রী ও সার্ভিস সার্চ করুন...' },
  popularSearchesTitle: { EN: 'POPULAR SEARCHES', BN: 'জনপ্রিয় অনুসন্ধানসমূহ' },
  searchPromptText: { EN: 'Search anything on Jadubazar', BN: 'যাদুবাজারে যেকোনো কিছু খুঁজুন' },
  noProductsFound: { EN: 'No products found', BN: 'কোনো পণ্য পাওয়া যায়নি' },
  noProductsSub: { EN: "We couldn't find anything matching your search. Try another item or brand.", BN: 'আপনার সার্চকৃত নামে কোনো পণ্য পাওয়া যায়নি। অন্য নাম দিয়ে চেষ্টা করুন।' },
  foundResultsText: { EN: 'Found results for', BN: 'ফলাফল পাওয়া গেছে' },

  // Category Sheet Modal Translations
  allCategoriesTitle: { EN: 'Categories', BN: 'ক্যাটাগরিসমূহ' },
  searchCategoryPlaceholder: { EN: 'Search categories...', BN: 'ক্যাটাগরি খুঁজুন...' },
  noCategoryFound: { EN: 'No categories found matching', BN: 'এমন কোনো ক্যাটাগরি পাওয়া যায়নি' },
  ...
  fastDeliveryTitleBadge: { EN: 'FAST DELIVERY', BN: 'দ্রুত ডেলিভারি' },
  fastDeliverySubBadge: { EN: 'Quick & reliable shipping', BN: 'দ্রুত ও নির্ভরযোগ্য শিপিং' },
